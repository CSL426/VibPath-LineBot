...
這是較大家一般所知的極低頻電磁波，一般是拿來作助眠使用。我們這一台的特色性質主要特點有兩個，波形很純極低失真度/磁場強度足，可以發揮更好的效果。

舒曼波(7.83HZ)算是α波的範圍，α波是在大腦靜下來之後的腦波狀態。相對於7.83HZ，依我們的經驗，8HZ的效果更好，雖然差異僅0.17HZ。""",

            "explain_13Freq": """🕉️ 13頻脈輪波

如其名，脈輪，屬於瑜珈的系統，對應從海底到頂輪，除了修行人的修行輔助使用之外，也是被拿來調理相對位置的健康。

波形都很漂亮，總諧波失真度都很低、磁場強度都很足。每一台機器，不只修行人輔助好用，一般人用也都很好。""",

            "explain_40hz": """⚡ γ波(GAMMA)，40HZ

這是人高度專注時大腦的腦波，使用這的目的同樣是期望誘發大腦的同步性，促使提高專注力。在醫學上也有不少研究，您可以GOOGLE「MIT 40HZ」。

波形都很漂亮，總諧波失真度都很低、磁場強度都很足。每一台機器，不只修行人輔助好用，一般人用也都很好。""",

            "explain_double_freq": """🔄 α/θ波

1、α波：舒曼波(7.83HZ)算是α波的範圍，α波是在大腦靜下來之後的腦波狀態。相對於7.83HZ，依我們的經驗，8HZ的效果更好，雖然差異僅0.17HZ。

2、θ波(4HZ)：和α波有不一樣的作用，4HZ是人在醒睡之間時大腦的腦波狀態。在助眠方面比α波有更積極的作用。另外這也是修行時很好的輔助機器，幫助修行人修行時更容易進入更深的定靜狀態。
